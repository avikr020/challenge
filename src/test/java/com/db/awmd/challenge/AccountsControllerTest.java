...
public class AccountsControllerTest {
    ...
    @Test
    public void amountTransfer_negative_amount() throws Exception {
        String accountIdFrom = "Id-360";
        Account accountFrom = new Account(accountIdFrom, new BigDecimal("100"));
        this.accountsService.createAccount(accountFrom);
        String accountIdTo = "Id-361";
        Account accountTo = new Account(accountIdTo, new BigDecimal("100"));
        this.accountsService.createAccount(accountTo);

        this.mockMvc.perform(post("/v1/accounts/transfer/").contentType(MediaType.APPLICATION_JSON)
                .content("{\"accountFrom\":\"Id-360\",\"accountTo\":\"Id-361\",\"transferAmount\":-1}")).andExpect(status().isBadRequest());
    }
}
